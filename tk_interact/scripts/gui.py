...
def set_ICONS():
    global ICONS
    ICONS.append(tk.PhotoImage(file=PATH + '/icons/' + 'outline_add_alarm_black_18dp.png'))
    ICONS.append(tk.PhotoImage(file=PATH + '/icons/' + 'outline_border_clear_black_18dp.png'))
    ICONS.append(tk.PhotoImage(file=PATH + '/icons/' + 'outline_lock_black_18dp.png'))
    ICONS.append(tk.PhotoImage(file=PATH + '/icons/' + 'outline_lock_open_black_18dp.png'))
